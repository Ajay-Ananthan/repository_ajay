...
public class test{
	...
	public static void main(String[] args) throws InterruptedException {
		...
		name1.sendKeys("Salesforce Automation by Ajay");
		String namety = name1.getAttribute("value");
		System.out.println(namety);
		driver.findElement(By.xpath("//input[@name='CloseDate']")).sendKeys("8/02/2022");
		...
		String namety2 = name2.getText();
		System.out.println(namety2);
		if(namety.equals(namety2)) {
